...
function Part3() {
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-[40%_50%] mt-5  gap-[100px] place-items-center mx-5 lg:mx-[80px]">
        <div className="relative">
          <img
            src={img1}
            className="size-[400px] rounded-b-2xl rounded-tr-2xl  img-fluid cursor-pointer"
          />
          <div className="absolute size-[400px]   border-2 -z-10 border-gray-400 top-[20px] left-[20px]"></div>
        </div>
        <div className="  flex flex-col justify-center">
          ...
          <p className="text-justify text-[14px] leading-[33px]">
            ...
            معمولا با این موضوع رو برو هستند که محتوای اصلی صفحات آماده نیست اگر
