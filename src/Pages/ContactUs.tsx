...
import { email, Instagram, phon, Telegram, Frame,image2 } from "../assets/images/contactus"
...
const ContactUs: React.FC = () => {
    return (
        <div className="lg:py-[54px] py-[20px] max-w-[1232px] mx-auto">

            <PhotoAndtitle img={image2} title="تماس با ما" text="خدمــات مهندســی ساختمانــی ســــاختبوم"/>
